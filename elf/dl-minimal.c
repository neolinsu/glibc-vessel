...
/* Defined below.  */
#ifdef VESSEL_RTDL
static struct minimal_ops *miniops;
#else
...
{
#ifdef VESSEL_RTDL
  miniops = vessel_get_ops();
  __rtld_calloc = (__typeof(calloc)*)miniops->calloc;
  __rtld_free = (__typeof(free)*)miniops->free;
  __rtld_malloc = (__typeof(malloc)*)miniops->malloc;
  __rtld_realloc = (__typeof(realloc)*)miniops->realloc;
#else
  __rtld_calloc = (__typeof(calloc)*)rtld_calloc;
  __rtld_free = (__typeof(free)*)rtld_free;
  __rtld_malloc = (__typeof(malloc)*)rtld_malloc;
  __rtld_realloc = (__typeof(realloc)*)rtld_realloc;
#endif
}
